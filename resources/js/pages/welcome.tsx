...
export default function Welcome() {
  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:justify-center items-center bg-[#FDFDFC] dark:bg-[#0a0a0a] p-6 lg:p-8 min-h-screen text-[#1b1b18]">
          ...
          <nav className="flex justify-end items-center gap-4">
            {auth.user ? (
              ...
              <>
                <Link
                  href={login()}
                  className="inline-block px-5 py-1.5 border hover:border-[#19140035] dark:hover:border-[#3E3E3A] border-transparent rounded-sm text-[#1b1b18] dark:text-[#EDEDEC] text-sm leading-normal"
                >
                  Log in
                </Link>
                <Link
        ...
        <div className="flex justify-center items-center opacity-100 starting:opacity-0 w-full transition-opacity duration-750 lg:grow">
          <main className="flex lg:flex-row flex-col-reverse w-full max-w-[335px] lg:max-w-4xl">
            <div className="flex-1 bg-white dark:bg-[#161615] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] p-6 lg:p-20 pb-12 lg:rounded-tl-lg rounded-bl-lg rounded-br-lg lg:rounded-br-none text-[13px] dark:text-[#EDEDEC] leading-[20px]">
              ...
              <ul className="flex flex-col mb-4 lg:mb-6">
                <li className="before:top-1/2 before:bottom-0 before:left-[0.4rem] before:absolute relative flex items-center gap-4 py-2 before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:border-l">
                  <span className="relative bg-white dark:bg-[#161615] py-1">
                    <span className="flex justify-center items-center bg-[#FDFDFC] dark:bg-[#161615] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-full w-3.5 h-3.5">
                      <span className="bg-[#dbdbd7] dark:bg-[#3E3E3A] rounded-full w-1.5 h-1.5" />
                    </span>
                  </span>
                  <span>
                    Read the
                    <a
                      ...
                      target="_blank"
                      className="inline-flex items-center space-x-1 ml-1 font-medium text-[#f53003] dark:text-[#FF4433] underline underline-offset-4"
                    >
                ...
                <li className="before:top-0 before:bottom-1/2 before:left-[0.4rem] before:absolute relative flex items-center gap-4 py-2 before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:border-l">
                  <span className="relative bg-white dark:bg-[#161615] py-1">
                    <span className="flex justify-center items-center bg-[#FDFDFC] dark:bg-[#161615] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-full w-3.5 h-3.5">
                      <span className="bg-[#dbdbd7] dark:bg-[#3E3E3A] rounded-full w-1.5 h-1.5" />
                    </span>
              ...
              <ul className="flex gap-3 text-sm leading-normal">
                <li>
                  <a
                    ...
                    target="_blank"
                    className="inline-block bg-[#1b1b18] hover:bg-black dark:bg-[#eeeeec] dark:hover:bg-white px-5 py-1.5 border dark:border-[#eeeeec] dark:hover:border-white border-black hover:border-black rounded-sm text-white dark:text-[#1C1C1A] text-sm leading-normal"
                  >
                    Deploy now
                  </a>
                </li>
            ...
            <div className="relative bg-[#fff2f2] dark:bg-[#1D0002] -mb-px lg:mb-0 lg:-ml-px rounded-t-lg lg:rounded-t-none lg:rounded-r-lg w-full lg:w-[438px] aspect-[335/376] lg:aspect-auto overflow-hidden shrink-0">
              <svg
                className="opacity-100 starting:opacity-0 w-full max-w-none text-[#F53003] dark:text-[#F61500] transition-all translate-y-0 starting:translate-y-6 duration-750"
                viewBox="0 0 438 104"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <svg
                className="dark:hidden relative -mt-[4.9rem] lg:-mt-[6.6rem] -ml-8 lg:ml-0 w-[448px] max-w-none"
                viewBox="0 0 440 376"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
                <g className="opacity-100 starting:opacity-0 transition-all translate-y-0 starting:translate-y-4 duration-750 delay-300">
                  <path
                ...
                <g
                  ...
                  className="opacity-100 starting:opacity-0 transition-all translate-y-0 starting:translate-y-4 duration-750 delay-300"
                >
                  <path
              ...
              <svg
                className="hidden dark:block relative -mt-[4.9rem] lg:-mt-[6.6rem] -ml-8 lg:ml-0 w-[448px] max-w-none"
                viewBox="0 0 440 376"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <div className="absolute inset-0 shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-t-lg lg:rounded-t-none lg:rounded-r-lg" />
            </div>
          </main>
        </div>
        <div className="hidden lg:block h-14.5"></div>
      </div>
    </>
  )
}
