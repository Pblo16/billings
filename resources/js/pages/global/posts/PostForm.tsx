...
import { ComboboxOption, FormFieldConfig, Post } from '@/types'
...
const getFormFieldsConfig = (users: ComboboxOption[]): FormFieldConfig[] => [
  {
    name: 'name',
    label: 'Name',
    type: 'text',
  ...
  },
  {
    ...
    options: users, // Las opciones se pueden pasar como prop si es necesario
    searchUrl: data().url, // URL para buscar opciones si es necesario
  },
]
...
const PostForm = ({
  ...
  const { props } = usePage()
  const users = (props.users as ComboboxOption[]) || []
